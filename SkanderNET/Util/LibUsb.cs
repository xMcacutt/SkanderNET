...
namespace SkanderNET
{
    internal static class LibUsb
    {
        ...
        [DllImport(DllPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern int libusb_control_transfer(IntPtr dev_handle, byte bmRequestType, byte bRequest, ushort wValue, ushort wIndex, byte[] data, ushort wLength, uint timeout);
        
        [DllImport(DllPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern void libusb_close(IntPtr dev_handle);
        
        [DllImport(DllPath, CallingConvention = CallingConvention.Cdecl)]
        public static extern int libusb_set_configuration(IntPtr dev_handle, int configuration);
    }
}